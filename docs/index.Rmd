...
- Learnr interactive document is not the same environment in which usual R programming happens. Learners might not realize how to apply their knowledge on longer codes.
...
- We made a fork of the package and translated the internal messages into Brazilian Portuguese, called {gradethisBR}.

- Gradethis translation to PT-BR: https://github.com/curso-r/gradethis (by [Fernando Corrêa](https://github.com/azeloc))
  
- {gradethisBR} is a temporary package and will be better if this feature is native in {gradethis} in the future. 
...
- We want to help improving {learnr}/{gradethis}/{learnrhash} to support additional languages as well, such as Brazilian Portuguese, Spanish and others.
